...
def thumb_top_start():
	...
	fs.noteon(0, last_note_thumb_top, pot0.value)
...
def thumb_right_start():
	...
	fs.noteon(0, last_note_thumb_right, pot0.value)
...
def thumb_bottom_start():
	...
	fs.noteon(0, last_note_thumb_bottom, pot0.value)
...
def index_finger_start():
	...
	fs.noteon(0, last_note_index_finger, pot0.value)
...
def middle_finger_start():
	...
	fs.noteon(0, last_note_middle_finger, pot0.value)
...
def ring_finger_start():
	...
	fs.noteon(0, last_note_ring_finger, pot0.value)
...
def pinky_finger_start():
	...
	fs.noteon(0, last_note_pinky_finger, pot0.value)
